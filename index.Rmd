...
However, that will only install the most recently released dev version. I could also host the package on an internal CRAN-like repository, or even better, on RStudio Package Manager. 

--

The basic benefit of Package Manager are:  
* Allowing for multiple versions of the package to be available  
* For all of the packages/dependencies to also be behind your firewall  
* For it to install all of the external package dependencies as binary packages (MASSIVELY faster install in Linux)  
