...
meta() %>%
  ...
  meta_social(
    ...
    description = paste(
      ...
      "RStudio and the tidyverse team have made it easy to get started",
      "building packages with RStudio, {devtools}, and {usethis}."
    ),
    url = "https://jthomasmock.github.io/pkg-building",
    image = "https://github.com/jthomasmock/pkg-building/tree/master/images/title-card.png",
    image_alt = paste(
...
#### Slides: [jthomasmock.github.io/pkg-building](https://jthomasmock.github.io/pkg-building)
